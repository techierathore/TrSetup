...
- **BRD-44** — `TrSetup` shall ship as a Windows unpackaged exe (`WindowsPackageType=None`) and as Mac Catalyst via MAUI, ad-hoc signed for personal LAN use. *(F-MAUIHEAD)* <!-- from: TrSetup-Plan.md §4, §10 -->
